...
jmp_39_E000:
	...
	BEQ bra_E02C	;branch
	LDA PlayerBackColl	;Though the name says behind, its actually for tiles that the player is standing over like coins
