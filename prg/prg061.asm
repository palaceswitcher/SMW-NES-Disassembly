...
EntitySet_World3:
	.byte OBJ_MIDWAYPOINT, OBJ_SPIKETOP, OBJ_SWOOPER+1, OBJ_BUZZYBEETLE, OBJ_SHELL, OBJ_MUSHROOM, OBJ_PARATROOPA_BOUNCING+1, OBJ_PIRANHAPLANT, OBJ_FOOTBALLCHUCK+1, OBJ_FIREFLOWER, OBJ_1UP_ALT, OBJ_MUSHROOM_HIDDEN, OBJ_BONUSBLOCK+5, 0, 0, OBJ_GOALTAPE
...
EntitySet_World7:
	...
	.byte OBJ_COUNTDOWNPLATFORM_1S, OBJ_COUNTDOWNPLATFORM_4S, OBJ_SPRING, OBJ_FEATHER, OBJ_FIREFLOWER, OBJ_MUSHROOM_IDLE, OBJ_PARATROOPA_BOUNCING+1, OBJ_PODOBOO_HORIZONTAL, OBJ_PARATROOPA_VERTICAL+1, OBJ_PARATROOPA_GREEN+1, OBJ_KOOPA+1, OBJ_BGPRIORITY_BELOW, OBJ_BONUSBLOCK+5, 0, OBJ_MIDWAYPOINT, OBJ_GOALTAPE+1
...
BonusLevel_EntitySet:
	.byte OBJ_BGPRIORITY_ABOVE, OBJ_BGPRIORITY_ABOVE+1, OBJ_PIPEEXIT, OBJ_BONUSBLOCK, OBJ_BONUSBLOCK+1, OBJ_BONUSBLOCK+2, OBJ_BONUSBLOCK+3, OBJ_BONUSBLOCK+4, 0, 0, 0, 0, 0, 0, 0, 0
tbl6_AA3A:
	.byte $00
	.byte $00
	.byte $00
