...
EntitySet_World1:
	...
	.byte OBJ_CHECKPOINT, OBJ_CHAINPLATFORM_RED, OBJ_CHAINPLATFORM_GREEN, OBJ_KOOPA+1, OBJ_PARATROOPA_GREEN+1, OBJ_ITEMBOX_YOSHI, OBJ_FIREFLOWER, OBJ_MUSHROOM, 0, 0, 0, 0, 0, 0, 0, OBJ_GOALTAPE+1
...
EntitySet_World2:
	.byte OBJ_CHECKPOINT, OBJ_SUPERKOOPA_CAPE, OBJ_SUPERKOOPA_JUMP, OBJ_SUPERKOOPA_ALT, OBJ_VOLCANOLOTUS+1, OBJ_PARATROOPA_BOUNCING, OBJ_PIRANHAPLANT, OBJ_ITEMBOX_YOSHI, OBJ_VINE, OBJ_PITCHINCHUCK+1, OBJ_MUSHROOM_HIDDEN, OBJ_STAR, OBJ_PIPE_BONUS, 0, 0, OBJ_GOALTAPE
	.byte OBJ_CHECKPOINT, OBJ_LINEPLATFORM, OBJ_LINEPLATFORM_ALT, OBJ_CHAINPLATFORM_GREEN, OBJ_KOOPA+1, OBJ_PARATROOPA_GREEN+1, OBJ_FEATHER, OBJ_PARATROOPA_BOUNCING+1, OBJ_FUZZY, OBJ_ONOFFBLOCK, OBJ_VINE, 0, 0, 0, 0, OBJ_GOALTAPE+1
	.byte 0, OBJ_BOOBUDDIES_GENERATOR, OBJ_BOO, OBJ_SWARMBOO_PATROLLING, OBJ_PSWITCH_BOXED, OBJ_PODOBOO_VERTICAL+1, OBJ_PODOBOO_DIAG, OBJ_1UP_ALT, OBJ_FIREFLOWER, OBJ_PSWITCHPLATFORM+2, OBJ_VINE+1, 0, 0, 0, 0, OBJ_GOALTAPE+1
...
EntitySet_World3:
	.byte OBJ_CHECKPOINT, OBJ_SPIKETOP, OBJ_SWOOPER+1, OBJ_BUZZYBEETLE, OBJ_SHELL, OBJ_MUSHROOM, OBJ_PARATROOPA_BOUNCING+1, OBJ_PIRANHAPLANT, OBJ_PUNTINCHUCK+1, OBJ_FIREFLOWER, OBJ_1UP_ALT, OBJ_MUSHROOM_HIDDEN, OBJ_BONUSBLOCK+5, 0, 0, OBJ_GOALTAPE
	...
	.byte 0, OBJ_BOOBUDDIES_GENERATOR, OBJ_BOO, OBJ_SWARMBOO_PATROLLING, OBJ_EERIE, OBJ_PSWITCHPLATFORM+1, OBJ_PSWITCH, OBJ_1UP_ALT, OBJ_FIREFLOWER, OBJ_PSWITCHPLATFORM+2, OBJ_VINE+1, 0, 0, 0, 0, OBJ_GOALTAPE+1
...
EntitySet_World4:
	.byte OBJ_CHECKPOINT, OBJ_SUPERKOOPA_ALT, OBJ_SUPERKOOPA_STRAIGHT, OBJ_UNSHELLEDKOOPA+1, OBJ_SHELL, OBJ_FEATHER, OBJ_ITEMBOX_YOSHI, OBJ_PIPE_BONUS, 0, 0, 0, 0, 0, 0, 0, OBJ_GOALTAPE+1
	.byte OBJ_CHECKPOINT, OBJ_CHAINPLATFORM_RED, OBJ_ROPE+1, OBJ_ROPE_LONG+1, OBJ_CHAINSAW_DOWN+1, OBJ_CHAINSAW_UP_ALT+1, OBJ_CHAINSAW_UP+1, OBJ_FEATHER, OBJ_PIPE_BONUS, 0, 0, 0, 0, 0, 0, OBJ_GOALTAPE
	.byte OBJ_CHECKPOINT, OBJ_UNSHELLEDKOOPA, OBJ_KOOPA, OBJ_CHARGINCHUCK_CHASE+1, OBJ_SHELL, OBJ_PIRANHAPLANT, OBJ_PIPE_BONUS, OBJ_ITEMBOX_YOSHI, OBJ_FEATHER, OBJ_1UP_ALT, OBJ_MUSHROOM_HIDDEN, OBJ_PARATROOPA_BOUNCING+1, OBJ_VINE, OBJ_UNSHELLEDKOOPA_SLIDING, OBJ_UNSHELLEDKOOPA_SLIDING_ALT, OBJ_GOALTAPE
...
EntitySet_World5:
	.byte OBJ_FIREFLOWER, OBJ_STAR, OBJ_KOOPA, OBJ_ITEMBOX_YOSHI, OBJ_GOOMBA+1, OBJ_CHARGINCHUCK_CHASE+1, OBJ_SPRING, OBJ_UNSHELLEDKOOPA, OBJ_CHARGINCHUCK_CHASE, OBJ_PARATROOPA_BOUNCING, OBJ_PUNTINCHUCK+1, OBJ_PIPE_BONUS, 0, 0, 0, OBJ_GOALTAPE+1
	.byte OBJ_BOO, OBJ_PSWITCHPLATFORM+2, OBJ_PSWITCH, OBJ_1UP_ALT, OBJ_FEATHER, OBJ_FIREFLOWER, OBJ_EERIE, OBJ_SWARMBOO_PATROLLING, 0, 0, 0, 0, 0, 0, 0, OBJ_GOALTAPE+1
...
EntitySet_World6:
	...
	.byte OBJ_PARATROOPA_VERTICAL, OBJ_PIRANHAPLANT, OBJ_PSWITCH, OBJ_CHARGINCHUCK_CHASE+1, OBJ_ITEMBOX_YOSHI, OBJ_MUSHROOM_HIDDEN, OBJ_MUSHROOM, OBJ_SPRING, OBJ_PIPE_CANNON, OBJ_PIPE_CANNON+1, OBJ_DINOTORCH+1, OBJ_DINORHINO+1, 0, 0, OBJ_CHECKPOINT, OBJ_GOALTAPE+1
	.byte OBJ_PODOBOO_DIAG_BOSS, OBJ_LEMMYWENDY, OBJ_NINJI, OBJ_FEATHER, OBJ_DRYBONES, OBJ_THWOMP+1, OBJ_SPIKE_UP+1, OBJ_SPIKE_UP_ALT+1, OBJ_SPIKE_DOWN+1, 0, 0, 0, 0, 0, OBJ_CHECKPOINT, OBJ_GOALTAPE+1

EntitySet_World7:
	.byte OBJ_KOOPA+1, OBJ_FEATHER, OBJ_PARATROOPA_VERTICAL+1, OBJ_CHAINPLATFORM_GREEN, OBJ_FUZZY, OBJ_STAR, 0, 0, 0, 0, 0, 0, 0, 0, OBJ_CHECKPOINT, OBJ_GOALTAPE+1
	.byte OBJ_COUNTDOWNPLATFORM_1S, OBJ_COUNTDOWNPLATFORM_4S, OBJ_SPRING, OBJ_FEATHER, OBJ_FIREFLOWER, OBJ_MUSHROOM_IDLE, OBJ_PARATROOPA_BOUNCING+1, OBJ_PODOBOO_HORIZONTAL, OBJ_PARATROOPA_VERTICAL+1, OBJ_PARATROOPA_GREEN+1, OBJ_KOOPA+1, OBJ_PIPE_BONUS, OBJ_BONUSBLOCK+5, 0, OBJ_CHECKPOINT, OBJ_GOALTAPE+1
...
BonusLevel_EntitySet:
	.byte OBJ_BGPRIORITY_ABOVE, OBJ_BGPRIORITY_ABOVE+1, OBJ_PIPE_BONUS_EXIT, OBJ_BONUSBLOCK, OBJ_BONUSBLOCK+1, OBJ_BONUSBLOCK+2, OBJ_BONUSBLOCK+3, OBJ_BONUSBLOCK+4, 0, 0, 0, 0, 0, 0, 0, 0
tbl6_AA3A:
	.byte $00
	.byte $00
	.byte $00
