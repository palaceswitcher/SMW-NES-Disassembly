...
EntitySet_World1:
	...
	.byte OBJ_MIDWAYPOINT, OBJ_VINE+1, OBJ_SHELL, OBJ_MUSHROOM, OBJ_PIRANHAPLANT+1, OBJ_ITEMBOX_YOSHI, OBJ_KOOPA, OBJ_CHARGINCHUCK_CHASE+1, OBJ_PSWITCH_BOXED, OBJ_PARATROOPA_BOUNCING, OBJ_PARAGOOMBA, OBJ_PARACHUTEGOOMBA, OBJ_PSWITCHPLATFORM, OBJ_STAR, 0, OBJ_GOALTAPE+1
	.byte OBJ_MIDWAYPOINT, OBJ_SHORTPLATFORM+1, OBJ_SHORTPLATFORM, OBJ_KOOPA+1, OBJ_PARATROOPA_GREEN+1, OBJ_ITEMBOX_YOSHI, OBJ_FIREFLOWER, OBJ_MUSHROOM, 0, 0, 0, 0, 0, 0, 0, OBJ_GOALTAPE+1
...
EntitySet_World2:
	.byte OBJ_MIDWAYPOINT, OBJ_SUPERKOOPA_CAPE, OBJ_SUPERKOOPA_JUMP, OBJ_SUPERKOOPA_ALT, OBJ_VOLCANOLOTUS+1, OBJ_PARATROOPA_BOUNCING, OBJ_PIRANHAPLANT, OBJ_ITEMBOX_YOSHI, OBJ_VINE, OBJ_BASEBALLCHUCK+1, OBJ_MUSHROOM_HIDDEN, OBJ_STAR, OBJ_PIPEEXIT, 0, 0, OBJ_GOALTAPE
...
EntitySet_World4:
	.byte OBJ_MIDWAYPOINT, OBJ_SUPERKOOPA_ALT, OBJ_SUPERKOOPA_STRAIGHT, OBJ_UNSHELLEDKOOPA+1, OBJ_SHELL, OBJ_FEATHER, OBJ_ITEMBOX_YOSHI, OBJ_PIPEEXIT, 0, 0, 0, 0, 0, 0, 0, OBJ_GOALTAPE+1
	...
	.byte OBJ_MIDWAYPOINT, OBJ_UNSHELLEDKOOPA, OBJ_KOOPA, OBJ_CHARGINCHUCK_CHASE+1, OBJ_SHELL, OBJ_PIRANHAPLANT, OBJ_PIPEEXIT, OBJ_ITEMBOX_YOSHI, OBJ_FEATHER, OBJ_1UP_ALT, OBJ_MUSHROOM_HIDDEN, OBJ_PARATROOPA_BOUNCING+1, OBJ_VINE, OBJ_UNSHELLEDKOOPA_SLIDING, OBJ_UNSHELLEDKOOPA_SLIDING_ALT, OBJ_GOALTAPE
...
EntitySet_World6:
	...
	.byte OBJ_PARATROOPA_VERTICAL, OBJ_PIRANHAPLANT, OBJ_PSWITCH, OBJ_CHARGINCHUCK_CHASE+1, OBJ_ITEMBOX_YOSHI, OBJ_MUSHROOM_HIDDEN, OBJ_MUSHROOM, OBJ_SPRING, OBJ_PSWITCHPLATFORM3, OBJ_PSWITCHPLATFORM3+1, OBJ_DINOTORCH+1, OBJ_DINORHINO+1, 0, 0, OBJ_MIDWAYPOINT, OBJ_GOALTAPE+1
