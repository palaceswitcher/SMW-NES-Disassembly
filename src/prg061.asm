...
EntitySet_World1:
	.byte OBJ_MIDWAYPOINT, 0, OBJ_UNSHELLEDKOOPA, OBJ_REX+1, OBJ_CHARGINCHUCK_CHASE, OBJ_PIRANHAPLANT, OBJ_MUSHROOM, OBJ_SHELL, OBJ_1UP_ALT, OBJ_FIREFLOWER, OBJ_PODOBOO_HORIZONTAL, OBJ_MUSHROOM_HIDDEN, OBJ_UNSHELLEDKOOPA_SLIDING, 0, 0, OBJ_GOALTAPE+1
...
EntitySet_World2:
	.byte OBJ_MIDWAYPOINT, OBJ_SUPERKOOPA_CAPE, OBJ_SUPERKOOPA_JUMP, OBJ_SUPERKOOPA_ALT, OBJ_VOLCANOLOTUS+1, OBJ_PARATROOPA_BOUNCING, OBJ_PIRANHAPLANT, OBJ_YOSHI, OBJ_VINE, OBJ_BASEBALLCHUCK+1, OBJ_MUSHROOM_HIDDEN, OBJ_STAR, OBJ_PIPEEXIT, 0, 0, OBJ_GOALTAPE
...
EntitySet_World4:
	.byte OBJ_MIDWAYPOINT, OBJ_SUPERKOOPA_ALT, OBJ_SUPERKOOPA_STRAIGHT, OBJ_UNSHELLEDKOOPA+1, OBJ_SHELL, OBJ_FEATHER, OBJ_YOSHI, OBJ_PIPEEXIT, 0, 0, 0, 0, 0, 0, 0, OBJ_GOALTAPE+1
	.byte OBJ_MIDWAYPOINT, OBJ_SHORTPLATFORM+1, OBJ_ROPE+1, OBJ_ROPE_LONG, OBJ_CHAINSAW_DOWN+1, OBJ_CHAINSAW_UP_ALT+1, OBJ_CHAINSAW_UP+1, OBJ_FEATHER, OBJ_PIPEEXIT, 0, 0, 0, 0, 0, 0, OBJ_GOALTAPE
	.byte OBJ_MIDWAYPOINT, OBJ_UNSHELLEDKOOPA, OBJ_KOOPA, OBJ_CHARGINCHUCK_CHASE+1, OBJ_SHELL, OBJ_PIRANHAPLANT, OBJ_PIPEEXIT, OBJ_YOSHI, OBJ_FEATHER, OBJ_1UP_ALT, OBJ_MUSHROOM_HIDDEN, OBJ_PARATROOPA_BOUNCING+1, OBJ_VINE, OBJ_UNSHELLEDKOOPA_SLIDING, OBJ_UNSHELLEDKOOPA_SLIDING_ALT, OBJ_GOALTAPE
...
EntitySet_World5:
	.byte OBJ_FIREFLOWER, OBJ_STAR, OBJ_KOOPA, OBJ_YOSHI, OBJ_GOOMBA+1, OBJ_CHARGINCHUCK_CHASE+1, OBJ_SPRING, OBJ_UNSHELLEDKOOPA, OBJ_CHARGINCHUCK_CHASE, OBJ_PARATROOPA_BOUNCING, OBJ_FOOTBALLCHUCK+1, OBJ_PIPEEXIT, 0, 0, 0, OBJ_GOALTAPE+1
...
EntitySet_World7:
	...
	.byte OBJ_COUNTDOWNPLATFORM_1S, OBJ_COUNTDOWNPLATFORM_4S, OBJ_SPRING, OBJ_FEATHER, OBJ_FIREFLOWER, OBJ_MUSHROOM_IDLE, OBJ_PARATROOPA_BOUNCING+1, OBJ_PODOBOO_HORIZONTAL, OBJ_PARATROOPA_VERTICAL+1, OBJ_PARATROOPA_GREEN+1, OBJ_KOOPA+1, OBJ_PIPEEXIT, OBJ_BONUSBLOCK+5, 0, OBJ_MIDWAYPOINT, OBJ_GOALTAPE+1
