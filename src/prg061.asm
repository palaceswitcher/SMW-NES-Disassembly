...
EntitySet_World2:
	.byte OBJ_CHECKPOINT, OBJ_SUPERKOOPA_CAPE, OBJ_SUPERKOOPA_JUMP, OBJ_SUPERKOOPA_ALT, OBJ_VOLCANOLOTUS+1, OBJ_PARATROOPA_BOUNCING, OBJ_PIRANHAPLANT, OBJ_ITEMBOX_YOSHI, OBJ_VINE, OBJ_PITCHINCHUCK+1, OBJ_MUSHROOM_HIDDEN, OBJ_STAR, OBJ_PIPEEXIT, 0, 0, OBJ_GOALTAPE
...
EntitySet_World5:
	.byte OBJ_FIREFLOWER, OBJ_STAR, OBJ_KOOPA, OBJ_ITEMBOX_YOSHI, OBJ_GOOMBA+1, OBJ_CHARGINCHUCK_CHASE+1, OBJ_SPRING, OBJ_UNSHELLEDKOOPA, OBJ_CHARGINCHUCK_CHASE, OBJ_PARATROOPA_BOUNCING, OBJ_PUNTINCHUCK+1, OBJ_PIPEEXIT, 0, 0, 0, OBJ_GOALTAPE+1
