...
tbl3_A1B5:
	...
	.export OBJ_SPRING := (*-tbl3_A1B5)/2
	.word objSpring

	.export OBJ_SHELL := (*-tbl3_A1B5)/2
	.word objShell

	.export OBJ_1UP := (*-tbl3_A1B5)/2
	.word obj1UP

	.export OBJ_PFIREBALL1 := (*-tbl3_A1B5)/2
	.word obj0x06
	...
	.export OBJ_FIREFLOWER := (*-tbl3_A1B5)/2
	.word obj0x0C

	.export OBJ_FEATHER := (*-tbl3_A1B5)/2
	.word obj0x0D

	.export OBJ_STAR := (*-tbl3_A1B5)/2
	.word obj0x0E

	.export OBJ_POP := (*-tbl3_A1B5)/2
	.word obj0x0F

	.export OBJ_KOOPA := (*-tbl3_A1B5)/2
	.word objKoopa
	.word objKoopa
	...
	.export OBJ_PARATROOPA_BOUNCING := (*-tbl3_A1B5)/2
	.word obj0x14
	.word obj0x14

	.export OBJ_REX := (*-tbl3_A1B5)/2
	.word obj0x16
	.word obj0x16

	.export OBJ_REX_STOMPED := (*-tbl3_A1B5)/2
	.word obj0x16
	.word obj0x16

	.export OBJ_PIRANHAPLANT := (*-tbl3_A1B5)/2
	.word obj0x1A
	.word obj0x1A

	.export OBJ_PIRANHAPLANTMASK := (*-tbl3_A1B5)/2
	.word obj0x1C
	.word obj0x1C

	.export OBJ_SUPERKOOPA_CAPE := (*-tbl3_A1B5)/2
	.word obj0x1E
	.word obj0x1E

	.export OBJ_SUPERKOOPA_JUMP := (*-tbl3_A1B5)/2
	.word obj0x1E

	.export OBJ_SUPERKOOPA_STRAIGHT := (*-tbl3_A1B5)/2 ; Verify this
	.word obj0x1E

	.export OBJ_SUPERKOOPA_ALT := (*-tbl3_A1B5)/2 ; Verify this
	.word obj0x1E

	.export OBJ_SUPERKOOPA_FLYUP := (*-tbl3_A1B5)/2 ; Verify this
	.word obj0x1E

	.export OBJ_VOLCANOLOTUS := (*-tbl3_A1B5)/2
	.word obj0x24
	.word obj0x24

	.export OBJ_LOTUSPOLLEN1 := (*-tbl3_A1B5)/2
	.word obj0x26
	.word obj0x26

	.export OBJ_LOTUSPOLLEN2 := (*-tbl3_A1B5)/2
	.word obj0x26
	.word obj0x26

	.export OBJ_LOTUSPOLLEN3 := (*-tbl3_A1B5)/2
	.word obj0x26
	.word obj0x26

	.export OBJ_LOTUSPOLLEN4 := (*-tbl3_A1B5)/2
	.word obj0x26
	.word obj0x26

	.export OBJ_SWOOPER := (*-tbl3_A1B5)/2
	.word obj0x2E
	.word obj0x2E

	.export OBJ_BLURP_HORIZONTAL := (*-tbl3_A1B5)/2
	.word obj0x30
	.word obj0x30

	.export OBJ_BLURP_VERTICAL := (*-tbl3_A1B5)/2
	.word obj0x30
	.word obj0x30

	.export OBJ_BLURP_ALT := (*-tbl3_A1B5)/2 ; Verify this
	.word obj0x30

	.export OBJ_BLURP_RIGHT := (*-tbl3_A1B5)/2 ; Verify this
	.word obj0x30
	...
	.export OBJ_MECHAKOOPA := (*-tbl3_A1B5)/2
	.word obj0x3A
	.word obj0x3A

	.export OBJ_MECHAKOOPA_STOMPED1 := (*-tbl3_A1B5)/2
	.word obj0x3C
	.word obj0x3C

	.export OBJ_MECHAKOOPA_STOMPED2 := (*-tbl3_A1B5)/2
	.word obj0x3C
	.word obj0x3C

	.export OBJ_MECHAKOOPA_STOMPED3 := (*-tbl3_A1B5)/2
	.word obj0x3C
	.word obj0x3C

	.export OBJ_BUZZYBEETLE := (*-tbl3_A1B5)/2
	.word obj0x42
	.word obj0x42

	.export OBJ_BUZZYSHELL := (*-tbl3_A1B5)/2
	.word obj0x44
	.word obj0x44

	.export OBJ_BUZZYSHELL_KICKED := (*-tbl3_A1B5)/2
	.word obj0x38
	.word obj0x38

	.export OBJ_PODOBOO_HORIZONTAL := (*-tbl3_A1B5)/2
	.word obj0x48

	.export OBJ_1UP_ALT := (*-tbl3_A1B5)/2 ; Verify this
	.word obj0x49

	.export OBJ_SPIKETOP := (*-tbl3_A1B5)/2
	.word obj0x4A
	.word obj0x4A

	.export OBJ_GOALTAPE := (*-tbl3_A1B5)/2
	.word obj0x4C
	.word obj0x4C

	.export OBJ_CLIMBINGKOOPA_HORIZONTAL := (*-tbl3_A1B5)/2
	.word obj0x4E
	.word obj0x4E

	.export OBJ_CLIMBINGKOOPA_VERTICAL := (*-tbl3_A1B5)/2
	.word obj0x4E ; 50
	.word obj0x4E ; 51

	.export OBJ_BLURPSTILL := (*-tbl3_A1B5)/2
	...
	.export OBJ_CHAINSAW_UP := (*-tbl3_A1B5)/2
	.word obj0x5A
	.word obj0x5A
	...
	.export OBJ_PODOBOO_DIAG := (*-tbl3_A1B5)/2
	.word obj0x64
	.word obj0x64

	.export OBJ_PSWITCHPLATFORM := (*-tbl3_A1B5)/2
	.word obj0x66
	.word obj0x66

	.export OBJ_PDOOR := (*-tbl3_A1B5)/2
	.word obj0x66
	.word obj0x66

	.export OBJ_PSWITCH_BOXED := (*-tbl3_A1B5)/2
	.word obj0x6A

	.export OBJ_MUSHROOM_IDLE := (*-tbl3_A1B5)/2
	.word obj0x6B

	.export OBJ_VINE := (*-tbl3_A1B5)/2
	.word obj0x6C
	.word obj0x6C
	...
	.export OBJ_MORTONROY := (*-tbl3_A1B5)/2
	.word obj0x70

	.export OBJ_PODOBOO_DIAG_BOSS := (*-tbl3_A1B5)/2
	.word obj0x64

	.export OBJ_LEMMYWENDY := (*-tbl3_A1B5)/2
	.word obj0x72
	...
	.export OBJ_ONOFFBLOCK := (*-tbl3_A1B5)/2
	.word obj0x76

	.export OBJ_REZNOR := (*-tbl3_A1B5)/2
	.word obj0x77

	.export OBJ_REZNORFIRE := (*-tbl3_A1B5)/2
...
; OBJECTS 80-FF ($A435)
tbl3_A435:
	.export OBJ_BULLETBILL := (*-tbl3_A435)/2 + $80
	.word obj0x80
	.word obj0x80

	.export OBJ_EERIE := (*-tbl3_A435)/2 + $80
	.word obj0x82
	.word obj0x82

	.export OBJ_THWOMP := (*-tbl3_A435)/2 + $80
	.word obj0x84
	.word obj0x84

	.export OBJ_URCHIN_VERTICAL := (*-tbl3_A435)/2 + $80
	.word obj0x86
	.word obj0x86

	.export OBJ_NINJI := (*-tbl3_A435)/2 + $80
	.word obj0x88
	.word obj0x88

	.export OBJ_FISHBONE := (*-tbl3_A435)/2 + $80
	.word obj0x8A
	.word obj0x8A

	.export OBJ_SPIKEBALL := (*-tbl3_A435)/2 + $80
	.word obj0x8C
	.word obj0x8C

	.export OBJ_PARACHUTEGOOMBA_ALT := (*-tbl3_A435)/2 + $80 ; Verify this
	.word obj0x8E
	.word obj0x8E

	.export OBJ_FUZZY_ALT := (*-tbl3_A435)/2 + $80 ; Verify this
	.word obj0x90
	.word obj0x90

	.export OBJ_URCHIN_HORIZONTAL := (*-tbl3_A435)/2 + $80
	.word obj0x92
	.word obj0x92

	.export OBJ_GOOMBA := (*-tbl3_A435)/2 + $80
	.word obj0x94
	.word obj0x94

	.export OBJ_GOOMBA_FLIPPED := (*-tbl3_A435)/2 + $80
	.word obj0x96
	.word obj0x96

	.export OBJ_PARACHUTEGOOMBA := (*-tbl3_A435)/2 + $80
	.word obj0x98
	.word obj0x98

	.export OBJ_SPINY := (*-tbl3_A435)/2 + $80
	.word obj0x9A
	.word obj0x9A

	.export OBJ_PODOBOO_VERTICAL := (*-tbl3_A435)/2 + $80
	.word obj0x9C
	.word obj0x9C

	.export OBJ_PODOBOO_DIAG_ALT := (*-tbl3_A435)/2 + $80 ; Verify this
	.word obj0x9E
	.word obj0x9E

	.export OBJ_PARAGOOMBA := (*-tbl3_A435)/2 + $80
	.word obj0xA0
	.word obj0xA0

	.export OBJ_DRYBONES_THROWING := (*-tbl3_A435)/2 + $80
	.word obj0xA2
	.word obj0xA2

	.export OBJ_DRYBONES := (*-tbl3_A435)/2 + $80
	.word obj0xA4
	.word obj0xA4

	.export OBJ_BONE := (*-tbl3_A435)/2 + $80
	.word obj0xA6
	.word obj0xA6

	.export OBJ_DRYBONES_THROW_BROKEN := (*-tbl3_A435)/2 + $80
	.word obj0xA8
	.word obj0xA8

	.export OBJ_DRYBONES_BROKEN := (*-tbl3_A435)/2 + $80
	.word obj0xA8 ; AA
	.word obj0xA8 ; AB

	.export OBJ_BONYBEETLE := (*-tbl3_A435)/2 + $80
	.word obj0xAA ; AC
	.word obj0xAA ; AD

	.export OBJ_BONYBEETLE_BROKEN := (*-tbl3_A435)/2 + $80
	.word obj0xAC ; AE
	.word obj0xAC ; AF
	...
	.export OBJ_BOOBUDDY := (*-tbl3_A435)/2 + $80
	.word obj0xB4
	.word obj0xB4

	.export OBJ_PRINCESSPEACH := (*-tbl3_A435)/2 + $80
	.word obj0xB6
	.word ptr4_A0D8
	...
	.export OBJ_MUSHROOM_PRINCESS := (*-tbl3_A435)/2 + $80
	.word obj0xBD

	.export OBJ_CHARGINCHUCK := (*-tbl3_A435)/2 + $80
	.word objCharginChuck
	.word objCharginChuck

	.export OBJ_CHARGINCHUCK_CHASE := (*-tbl3_A435)/2 + $80
	.word obj0xC0
	.word obj0xC0 ; Actually C2

	.export OBJ_CHARGINCHUCK_STUNNED := (*-tbl3_A435)/2 + $80
	.word obj0xC2
	.word obj0xC2
	...
	.export OBJ_DIGGINCHUCK := (*-tbl3_A435)/2 + $80
	.word obj0xD2
	.word obj0xD2
	...
	.export OBJ_PROPELLER := (*-tbl3_A435)/2 + $80
	.word obj0xDE ; E0

	.export OBJ_BOWSER := (*-tbl3_A435)/2 + $80
	.word obj0xDF

	.export OBJ_SPIKE_UP := (*-tbl3_A435)/2 + $80
	.word obj0xE0
	.word obj0xE0

	.export OBJ_DINORHINO := (*-tbl3_A435)/2 + $80
	.word obj0xE2 ; E4
	.word obj0xE2

	.export OBJ_DINOTORCH := (*-tbl3_A435)/2 + $80
	.word obj0xE4
	.word obj0xE4

	.export OBJ_1UP_BONUS := (*-tbl3_A435)/2 + $80
	.word obj0xE6

	.export OBJ_BONUSBLOCKCOIN := (*-tbl3_A435)/2 + $80
	.word obj0xE7

	.export OBJ_BONUSBLOCK := (*-tbl3_A435)/2 + $80
	.word obj0xE8 ; Row 1
	.word obj0xE8 ; Row 2
	.word obj0xE8 ; Row 3
	.word obj0xE8 ; Row 4
	...
	.export OBJ_PARATROOPA_VERTICAL := (*-tbl3_A435)/2 + $80
	.word obj0x58
	.word obj0x58

	.export OBJ_COUNTDOWNPLATFORM_1S := (*-tbl3_A435)/2 + $80
	.word obj0xFA ; FC
	.word obj0xFA

	.export OBJ_COUNTDOWNPLATFORM_4S := (*-tbl3_A435)/2 + $80
	.word obj0xFA ; FE
	.word obj0xFA
